...
SpriteNPC::SpriteNPC(){
    ...
    sf::String ruta = "resources/Sprites/NPC/NPCMago.png";
    //cargar textura
...
//cambiar sprite
void SpriteNPC::cambiarSpriteNPC(sf::Texture *textura, int n1, int n2, sf::Vector2i frm){
    //grids en x
    cantidadXNPC = n1;
    //grids en y
    cantidadYNPC = n2;
...
void SpriteNPC::seleccionarFrameNPC(){
...
bool SpriteNPC::animarMuerteNPC(){
    bool result = false;
    //no es el ultimo frame
...
void SpriteNPC::cambiarFrameXNPC(int frame){
    //cambio frame en x
    frActualNPC.x = frame;
    seleccionarFrameNPC();
...
void SpriteNPC::cambiarFrameYNPC(int frame){
    //cambio frame n y
    frActualNPC.y = frame;
    seleccionarFrameNPC();
}